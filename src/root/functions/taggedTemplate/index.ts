...
export { default as isTemplateStringsArray } from "src/root/functions/taggedTemplate/isTemplateStringsArray";
export {
  default as normaliseIndents,
  normalizeIndents,
} from "src/root/functions/taggedTemplate/normaliseIndents";
